...
final class LangCoverageTest extends TestCase
{
    ...
    public function testAllGitKeysPresent(): void
    {
        $langFile = __DIR__ . '/../lang/en.php';
        $translations = require $langFile;
        $this->assertArrayHasKey('git.spawn_failed', $translations);
        $this->assertArrayHasKey('git.error',        $translations);
    }

    public function testAllCliKeysPresent(): void
    {
        $langFile = __DIR__ . '/../lang/en.php';
        $translations = require $langFile;
        $this->assertArrayHasKey('cli.not_a_repo', $translations);
    }

    public function testAllUiKeysPresent(): void
    {
        $langFile = __DIR__ . '/../lang/en.php';
        $translations = require $langFile;
        $this->assertArrayHasKey('ui.error_prefix', $translations);
    }
    ...
    public function testAllStatusKeysPresent(): void
    {
        $langFile = __DIR__ . '/../lang/en.php';
        $translations = require $langFile;
        $this->assertArrayHasKey('status.clean', $translations);
    }

    public function testAllBranchesKeysPresent(): void
    {
        $langFile = __DIR__ . '/../lang/en.php';
        $translations = require $langFile;
        $this->assertArrayHasKey('branches.empty', $translations);
    }

    public function testAllLogKeysPresent(): void
    {
        $langFile = __DIR__ . '/../lang/en.php';
        $translations = require $langFile;
        $this->assertArrayHasKey('log.empty', $translations);
    }

    public function testAllHelpKeysPresent(): void
    {
        $langFile = __DIR__ . '/../lang/en.php';
        $translations = require $langFile;
        $this->assertArrayHasKey('help.keyhints', $translations);
    }
